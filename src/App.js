...
class App extends Component {
  ...
  onMainSubmit = (route) => {
    if (this.state.origin !== "" && this.state.destination !== "") {
      ...
      this.onRouteChange("submit-error");
    }
  };
        ...
        <header className="App-header">
          {route === "impossible" ? (
            <div className="center f3">
              <p>Woah buddy, that won't work. </p>
              <p>
                Are you trying to cross oceans? The Himalayas? Dicey political
                borders?
              </p>
              <button
            ...
            <div className="center f3">
              <p>Hey. Follow the rules.</p>
              <p>
                Please pick an ORIGIN and DESTINATION from the Google dropdown
                before submitting.
              </p>
              <button
                onClick={() => this.onSubmit("start")}
            ...
            <div className="center f3">
              <p>
                Oh my God. I'm so sorry. There are no McNuggets in your origin
                country.
              </p>
            ...
            <Nuggulator {...this.state} onRouteChange={this.onRouteChange} />
          ) : route === "body" ? (
            <Bodyweight
              {...this.state}
              onRouteChange={this.onRouteChange}
