...
class Navigation extends React.Component {
    ...
    componentDidMount() {
        ...
        this.autocompleteDestination = new google.maps.places.Autocomplete(this.autocompleteInputDestination.current);
        this.autocompleteDestination.addListener('place_changed', this.handleDestinationChanged);
        ...
        return (
          ...
          <div className = "center">
            <div className = "form center pa4 br3 shadow-5">
                ...
                <input ref = {this.autocompleteInputOrigin} 
                id= "origin" 
                placeholder ="Origin"
                aria-label = "origin"
                type = "text"
                className = "form pa1 center"></input>
                
                <input ref = {this.autocompleteInputDestination} 
                id= "destination" 
            ...
            dib white bg-light-purple"> Submit</button>
            </div>
            </div>
            </div>
